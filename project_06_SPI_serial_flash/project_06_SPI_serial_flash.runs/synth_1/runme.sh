...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_06_SPI_serial_flash/project_06_SPI_serial_flash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p06_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p06_top.tcl
