...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_06_SPI_serial_flash/project_06_SPI_serial_flash.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p06_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p06_top.tcl -notrace
