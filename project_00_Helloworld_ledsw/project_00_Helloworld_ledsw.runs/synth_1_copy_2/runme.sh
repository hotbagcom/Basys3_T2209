...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_00_Helloworld_ledsw/project_00_Helloworld_ledsw.runs/synth_1_copy_2'
cd "$HD_PWD"
...
EAStep vivado -log project_btnled_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_btnled_top.tcl
