...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/proje_sw_btn_led_test/proje_sw_btn_led_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_module.tcl
