...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/spi_vx/project_04_SPI/project_04_SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p04_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p04_top.tcl -notrace
