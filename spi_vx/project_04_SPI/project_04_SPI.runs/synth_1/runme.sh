...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/spi_vx/project_04_SPI/project_04_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p04_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p04_top.tcl
