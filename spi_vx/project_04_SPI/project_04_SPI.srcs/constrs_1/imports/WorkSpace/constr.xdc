...
set_property IOSTANDARD LVCMOS33 [get_ports {ard_SPI_clk_in}]
set_property IOSTANDARD LVCMOS33 [get_ports {ard_SPI_E_in}]
set_property IOSTANDARD LVCMOS33 [get_ports {ard_SPI_MOSI_in}]
