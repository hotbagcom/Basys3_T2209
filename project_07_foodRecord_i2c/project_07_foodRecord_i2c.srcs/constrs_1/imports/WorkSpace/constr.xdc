...
set_property PACKAGE_PIN C15 [get_ports {OLED_SCL}]
set_property PACKAGE_PIN C16 [get_ports {OLED_SDA}]
...
set_property PACKAGE_PIN U18 [get_ports {BTN_TRIGGER}]
#set_property PACKAGE_PIN U17 [get_ports {BTN_top[1]}]
set_property PACKAGE_PIN T18 [get_ports {CPU_RESETN}]
