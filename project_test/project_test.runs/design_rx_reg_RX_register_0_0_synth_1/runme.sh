...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_test/project_test.runs/design_rx_reg_RX_register_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_rx_reg_RX_register_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_rx_reg_RX_register_0_0.tcl
