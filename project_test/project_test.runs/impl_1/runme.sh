...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_test/project_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_rx_reg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_rx_reg_wrapper.tcl -notrace
