...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "maxsevensinglecounter" -parent ${Page_0}
...
proc update_PARAM_VALUE.maxsevensinglecounter { PARAM_VALUE.maxsevensinglecounter } {
	# Procedure called to update maxsevensinglecounter when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.maxsevensinglecounter { PARAM_VALUE.maxsevensinglecounter } {
	# Procedure called to validate maxsevensinglecounter
	return true
}
...
proc update_MODELPARAM_VALUE.maxsevensinglecounter { MODELPARAM_VALUE.maxsevensinglecounter PARAM_VALUE.maxsevensinglecounter } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.maxsevensinglecounter}] ${MODELPARAM_VALUE.maxsevensinglecounter}
}
