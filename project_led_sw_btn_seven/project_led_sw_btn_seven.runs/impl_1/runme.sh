...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_led_sw_btn_seven/project_led_sw_btn_seven.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log userinterface_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source userinterface_module.tcl -notrace
