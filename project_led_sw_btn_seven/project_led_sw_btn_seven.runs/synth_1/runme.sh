...
HD_PWD='C:/Users/arify/WorkSpace/Basys3_T2209/project_led_sw_btn_seven/project_led_sw_btn_seven.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log userinterface_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source userinterface_module.tcl
